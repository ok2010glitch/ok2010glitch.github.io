...
function changingLevels(){
 ...
 if(level === 2){
  ...
  //moving platform
  plat.push(new platform(350,390,200,40,2,850));
  plat.push(new platform(950,320,60,canvasH,0,0));
    ...
    for(let p of plat){
      if(
        ...
        if(
          ...
          if(p.vx !== 0){ // makes the player move along with the platform
            this.x += p.vx;
          }
        }
